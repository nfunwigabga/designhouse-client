  ...
  ? (function() {
              ...
              if (dataView.getUint16(0) === 0xffd8) {
                ...
                if (!options.disableImageHead && headLength > 6) {
                  if (buffer.slice) {
                    ...
                    data.imageHead = new Uint8Array(buffer).subarray(
                      0,
                      headLength
                    );
                  }
      ...
      var snabbt = (function() {
          ...
          if (elements.length !== undefined) {
            ...
            for (var i = 0, len = elements.length; i < len; ++i) {
              if (typeof arg2 == 'string')
                aggregateChainer.chainers.push(
                  snabbtSingleElement(
                    elements[i],
                    arg2,
                    preprocessOptions(arg3, i, len)
                  )
                );
              else
                aggregateChainer.chainers.push(
            ...
            if (typeof arg2 == 'string')
              return snabbtSingleElement(
                elements,
                arg2,
                preprocessOptions(arg3, 0, 1)
              );
            else
              return snabbtSingleElement(
                elements,
                preprocessOptions(arg2, 0, 1),
                arg3
              );
          }
        };
        ...
        var tickAnimations = function(time) {
          ...
          var finishedAnimations = runningAnimations.filter(function(
            animation
          ) {
        ...
        var createAnimation = function(options) {
          ...
          var easing = createEaser(
            optionOrDefault(options.easing, 'linear'),
            options
          );
          var currentState =
            duration === 0 ? endState.clone() : startState.clone();
          ...
          if (options.valueFeeder) {
            tweener = createValueFeederTweener(
              options.valueFeeder,
              startState,
              endState,
              currentState
          ...
          return {
            ...
            tick: function(time) {
              ...
              if (time - startTime > delay) {
                ...
                var curr = Math.min(
                  Math.max(0.0, currentTime - startTime),
                  duration
                );
            ...
            setValue: function(_manualValue) {
              started = true;
              manualValue = Math.min(
                Math.max(_manualValue, 0.0001),
                1 + manualDelayFactor
              );
            },
          ...
          return {
            ...
            updateMovement: function() {
              ...
              if (tweenRotationPost) {
                currentMovement.rotationPost[0] =
                  movement.rotationPost[0] * value;
                currentMovement.rotationPost[1] =
                  movement.rotationPost[1] * value;
                currentMovement.rotationPost[2] =
                  movement.rotationPost[2] * value;
              }
              if (tweenScale) {
        ...
        var createSpringEasing = function(options) {
          ...
          var equilibriumPosition = optionOrDefault(
            options.equilibriumPosition,
            1
          );
          ...
          return {
            tick: function(value) {
              ...
              var springForce =
                -(position - equilibriumPosition) * springConstant;
              // f = m * a
              // a = f / m
              ...
              if (
                Math.abs(position - equilibriumPosition) < 0.001 &&
        ...
        var createMatrix = function() {
          ...
          return {
            ...
            asCSS: function() {
              var css = 'matrix3d(';
              for (var i = 0; i < 15; ++i) {
                if (Math.abs(data[i]) < 0.0001) css += '0,';
                else css += data[i].toFixed(10) + ',';
              }
              if (Math.abs(data[15]) < 0.0001) css += '0)';
              else css += data[15].toFixed(10) + ')';
              return css;
            },
          ...
          return {
            ...
            clone: function() {
              return createState({
                ...
                rotationPost: this.rotationPost
                  ? this.rotationPost.slice(0)
                  : undefined,
          ...
          return {
            tween: function(tweenValue) {
              ...
              if (tweenRotationPost) {
                ...
                result.rotationPost[0] =
                  start.rotationPost[0] + tweenValue * dBX;
                result.rotationPost[1] =
                  start.rotationPost[1] + tweenValue * dBY;
                result.rotationPost[2] =
                  start.rotationPost[2] + tweenValue * dBZ;
              }
        ...
        var createValueFeederTweener = function(
          valueFeeder,
          startState,
          endState,
          resultState
      ...
      var stackBlur = (function() {
        ...
        function getImageDataFromCanvas(canvas, top_x, top_y, width, height) {
          ...
          else if (!canvas instanceof HTMLCanvasElement) return;
        ...
        if (typeof el.dataset === 'undefined') {
          ...
          for (attr in attrs) {
            if (
              ...
              attrs[attr].name &&
              /^data-[a-z_\-\d]*$/i.test(attrs[attr].name)
            ) {
      ...
      var send = function send(url) {
        ...
        xhr.onreadystatechange = function() {
          if (xhr.readyState === 4 && xhr.status >= 200 && xhr.status < 300) {
            ...
            if (
              (typeof _obj === 'undefined' ? 'undefined' : _typeof(_obj)) ===
                'object' &&
              _obj.status === 'failure'
            ) {
              err(_obj.message);
      ...
      var getMimeTypeFromResponseType = function getMimeTypeFromResponseType(
        responseType
      ) {
        var type = void 0;
        for (type in MimeTypes) {
      ...
      var getFileNameByFile = function getFileNameByFile(file) {
        if (typeof file.name === 'undefined') {
          return (
            ...
            '.' +
            getExtensionByMimeType(getFileTypeByFile(file))
          );
        }
        return file.name;
      };
      ...
      var loadRemoteURL = function loadRemoteURL(
        fetcher,
        fetchRequestDecorator,
        loadRequestDecorator,
        url,
        err,
        cb
      ) {
      ...
      var loadURL = function loadURL(url, requestDecorator, cb, err) {
        ...
        xhr.onload = function(e) {
          if (
            ...
            (xhr.status === 0 && this.response instanceof Blob)
          ) {
            // continue
      ...
      var getImageAsCanvas = function getImageAsCanvas(src, size, callback) {
        ...
        var crossOrigin =
          typeof src === 'string' ? src.indexOf('data:image') !== 0 : true;
        ...
        if (crop) {
          ...
          if (rotation === 90) {
            ...
            ctx.drawImage(
              ...
              (1 - py) * canvas.width - canvas.width * ph,
              crop.x,
              crop.height,
              crop.width,
            ...
            ctx.drawImage(
              ...
              // source rectangle (crop area)
              crop.y,
              (1 - px) * canvas.height - canvas.height * pw,
              crop.height,
              crop.width,
      ...
      function scaleCanvas(canvas, scalar, bounds, min) {
        ...
        var targetWidth = Math.max(
          min.width,
          Math.min(bounds.width, Math.round(canvas.width * scalar))
        );
        var targetHeight = Math.max(
          min.height,
          Math.min(bounds.height, Math.round(canvas.height * scalar))
        );
      ...
      var filter = function filter(canvas, _filter) {
        var ctx = canvas.getContext('2d');
        ctx.putImageData(
          _filter(getPixels(canvas), canvas.width, canvas.height),
          0,
          0
        );
      };
      ...
      var covers = function covers(image, rect) {
        return (
          parseInt(image.width, 10) >= rect.width &&
          parseInt(image.height, 10) >= rect.height
        );
      };
      ...
      var toDataURL = function toDataURL(image, type, jpegCompression) {
        ...
        return canvas.toDataURL(
          type,
          isJPEGMimeType(type) && typeof jpegCompression === 'number'
            ? jpegCompression / 100
            : undefined
        );
      };
      ...
      var flattenData = function flattenData(obj) {
        ...
        if (inArray('output', props)) {
          data.output = {
            name: forcedType
              ? getFileNameWithoutExtension(obj.input.name) + '.' + forcedType
              : obj.input.name,
          ...
          if (data.output.type === 'image/png') {
            data.output.name =
              getFileNameWithoutExtension(data.input.name) + '.png';
          }
        }
      ...
      var downloadCanvas = function downloadCanvas(
        data,
        jpegCompression,
        forcedType
      ) {
        var canvas = data.output.image;
        var filename = forcedType
          ? getFileNameWithoutExtension(data.input.name) + '.' + forcedType
          : data.input.name;
        ...
        canvas.toBlob(
          ...
          type,
          typeof jpegCompression === 'number'
            ? jpegCompression / 100
            : undefined
        );
      };

      var toggleDisplayBySelector = function toggleDisplayBySelector(
        selector,
        enabled,
        root
      ) {
      ...
      var CropArea = (function() {
        var resizers = {
          ...
          ne: function ne(rect, offset, space, ratio) {
            ...
            h = ratio
              ? (r - l) * ratio
              : limit(b - offset.y, space.min.height, b);
          ...
          se: function se(rect, offset, space, ratio) {
            ...
            h = ratio
              ? (r - l) * ratio
              : limit(offset.y - rect.y, space.min.height, space.height - t);
          ...
          _createClass(CropArea, [
            ...
            },
            {
              ...
              value: function _onDrag(e) {
                ...
                if (type === 'c') {
                  this._rect.x = limit(
                    offset.x - this._interaction.offset.x,
                    0,
                    this._space.width - this._rect.width
                  );
                  this._rect.y = limit(
                    offset.y - this._interaction.offset.y,
                    0,
                    this._space.height - this._rect.height
                  );
                } else if (resizers[type]) {
                  // resize
                  this._rect = resizers[type](
                    this._rect,
                    {
            ...
            },
            {
              ...
              value: function _redraw() {
                ...
                if (this._rectChanged) {
                  var transform =
                    'translate(' + this._rect.x + 'px,' + this._rect.y + 'px);';
            ...
            [
              {
                ...
                value: function _init() {
                  ...
                  // canvas ghost
                  this._previewWrapper = create(
                    'div',
                    'slim-image-editor-preview slim-crop-preview'
                  );
                  ...
                  ImageEditor.Buttons.forEach(function(c) {
                    ...
                    var className =
                      _this2._options['button' + prop + 'ClassName'];
                    var btn = create(
                      'button',
                      'slim-editor-btn slim-btn-' +
                        c +
                        (className ? ' ' + className : '')
                    );
                    btn.innerHTML = label;
                  ...
                  var btn = create(
                    'button',
                    'slim-editor-utils-btn slim-btn-rotate' +
                      (this._options.buttonRotateClassName
                        ? ' ' + this._options.buttonRotateClassName
                        : '')
                  );
              ...
              },
              {
                ...
                value: function _updateWrapperRotation() {
                  if (
                    this._options.minSize.width > this._input.height ||
                    this._options.minSize.height > this._input.width
                  ) {
              ...
              },
              {
                ...
                value: function _confirm() {
                  ...
                  var result = scaleRect(
                    area,
                    isTilted ? this._input.height : this._input.width,
                    isTilted ? this._input.width : this._input.height
                  );
                ...
                value: function _redrawCropMask() {
                  ...
                  this._maskFrame = requestAnimationFrame(function() {
                    ...
                    _this4._preview.style.cssText =
                      '\n\t\t\t\t\twidth: ' +
                      _this4._previewSize.width +
                      'px;\n\t\t\t\t\theight: ' +
                      _this4._previewSize.height +
                      'px;\n\t\t\t\t\t-webkit-transform: ' +
                      transform +
                      ';\n\t\t\t\t\ttransform: ' +
                      transform +
              ...
              },
              {
                ...
                value: function open(image, ratio, crop, rotation, complete) {
                  ...
                  if (
                    ...
                    !this._dirty &&
                    this._ratio === ratio &&
                    this._wrapperRotation === rotation
                  ) {
                    complete();
                    return;
                  }
                  ...
                  var relativeCrop = divideRect(
                    crop,
                    tilted ? image.height : image.width,
                    tilted ? image.width : image.height
                  );
                  ...
                  var previewCanvas = cloneCanvasScaled(
                    this._input,
                    Math.min(
                      this._container.offsetWidth / this._input.width,
                      this._container.offsetHeight / this._input.height
                    ) * this._options.devicePixelRatio
                  );
                  this._preview.src = '';
              ...
              },
              {
                ...
                value: function _redrawCropper(rect) {
                  ...
                  // image ratio
                  var imageRatio = isTilted
                    ? this._input.height / this._input.width
                    : this._input.width / this._input.height;
                  ...
                  this._cropper.offset(
                    sx + this._element.offsetLeft,
                    sy + this._element.offsetTop
                  );

                  // set min and max height of cropper
                  this._cropper.minWidth =
                    this._wrapperScale *
                    this._options.minSize.width *
                    this.scalar;
                  this._cropper.minHeight =
                    this._wrapperScale *
                    this._options.minSize.height *
                    this.scalar;
              ...
              },
              {
                ...
                value: function _redraw() {
                  ...
                  if (!this._blurredPreview) {
                    ...
                    this._previewBlurred.height =
                      this._previewBlurred.width * ratio;
              ...
              },
              {
                ...
                value: function show() {
                  ...
                  if (
                    this._currentWindowSize.width !== window.innerWidth ||
                    this._currentWindowSize.height !== window.innerHeight
                  ) {
              ...
              },
              {
                ...
                value: function destroy() {
                  ...
                  nodeListToArray(this._btnGroup.children).forEach(function(
                    btn
                  ) {
            ...
            },
            {
              ...
              value: function areValidDataTransferItems(items) {
                if (this._accept.length && items) {
                  ...
                  if (
                    items[0].type &&
                    items[0].type.indexOf('application') === 0
                  ) {
                    return null;
                  }
              ...
              value: function _onDrop(e) {
                ...
                if (remote) {
                  ...
                  if (!filesValidity) {
                    ...
                    this._element.dispatchEvent(
                      new CustomEvent('file-invalid-drop')
                    );
      ...
      var Slim = (function() {
        function Slim(element) {
          ...
          if (this._options.forceSize) {
            ...
            this._options.ratio =
              this._options.forceSize.width +
              ':' +
              this._options.forceSize.height;
          ...
          if (typeof this._options.post === 'string') {
            this._options.post = this._options.post
              .split(',')
              .map(function(part) {
                return part.trim();
              });
          ...
          this._initialRotation =
            this._options.rotation && this._options.rotation % 90 === 0
          ...
          [
            {
              ...
              value: function setRotation(rotation, callback) {
                ...
                if (this._data.input.image) {
                  var w = isTilted
                    ? this._data.input.image.height
                    : this._data.input.image.width;
                  var h = isTilted
                    ? this._data.input.image.width
                    : this._data.input.image.height;
              ...
              value: function setRatio(ratio, callback) {
                ...
                if (this._isFixedRatio()) {
                  ...
                  if (this._data.input.image && callback) {
                    ...
                    if (this._data.input.image) {
                      this._data.actions.crop = getAutoCropRect(
                        this._data.input.image.width,
                        this._data.input.image.height,
                        this._ratio
                      );
            ...
            },
            {
              ...
              value: function isAttachedTo(element) {
                return (
                  this._element === element || this._originalElement === element
                );
              }
            },
            {
            ...
            },
            {
              ...
              value: function load(src) {
                ...
                if (typeof options === 'function') {
                  ...
                  // initial rotation
                  this._initialRotation =
                    options.rotation && options.rotation % 90 === 0
                      ? options.rotation
                      : null;
            ...
            },
            {
              ...
              value: function _toggleButton(action, state) {
                toggleDisplayBySelector(
                  '.slim-btn[data-action="' + action + '"]',
                  state,
                  this._element
                );
              }
            ...
            },
            {
              ...
              value: function _init() {
                ...
                this._output = this._element.querySelector(
                  'input[type=hidden]'
                );
                ...
                if (!this._output) {
                  ...
                  this._output.name =
                    this._input.name || this._options.defaultInputName;
                ...
                var initialImageName = initialImage
                  ? initialImage.getAttribute('data-filename')
                  : null;
                ...
                var resultHTML =
                  '\n\t\t<div class="slim-result">\n\t\t\t<img class="in" style="opacity:0" ' +
                  (initialImageSrc ? 'src="' + initialImageSrc + '"' : '') +
                ...
                if (this._isImageOnly()) {
                  area.innerHTML =
                    ...
                    '\n\t\t\t\t' +
                    resultHTML +
                    '\n\t\t\t\t<div class="slim-status"><div class="slim-label-loading">' +
                  ...
                  if (
                    !this._input.hasAttribute('accept') ||
                    this._input.getAttribute('accept') === 'image/*'
                  ) {
                    mimetypes = getCommonMimeTypes();
                    this._input.setAttribute('accept', mimetypes.join(','));
                  } else {
                    mimetypes = this._input.accept
                      .split(',')
                  ...
                  this._imageHopper.allowURLs =
                    typeof this._options.fetcher === 'string';
                  ...
                  area.innerHTML =
                    ...
                    '\n\t\t\t\t' +
                    SlimUploadStatusHTML +
                    '\n\t\t\t\t<div class="slim-drip"><span><span></span></span></div>\n\t\t\t\t<div class="slim-status"><div class="slim-label">' +
                    (this._options.label || '') +
                    '</div><div class="slim-label-loading">' +
                    (this._options.labelLoading || '') +
                    '</div></div>\n\t\t\t\t' +
                    resultHTML +
                    '\n\t\t\t';
                ...
                SlimButtons.filter(function(c) {
                  ...
                  var title =
                    _this12._options['button' + prop + 'Title'] || label;
                  var className =
                    _this12._options['button' + prop + 'ClassName'];
                  var btn = create(
                    'button',
                    'slim-btn slim-btn-' +
                      c +
              ...
              value: function _onInit() {
                ...
                var done = function done() {
                  ...
                  var timer = setTimeout(function() {
                    ...
                    _this13._options.didInit.apply(_this13, [
                      _this13.data,
                      _this13
                    ]);
                  }, 0);
            ...
            },
            {
              ...
              value: function _updateProgress(progress) {
                ...
                var ringWidth = parseInt(
                  paths[0].getAttribute('stroke-width'),
                  10
                );

                // loader is not visible yet
                if (size * 0.5 < ringWidth) {
                  return;
                }
            ...
            },
            {
              ...
              value: function _onClick(e) {
                ...
                switch (target.getAttribute('data-action')) {
                  case 'remove':
                    this._options.willRemove.apply(this, [
                      this.data,
                      function() {
                        _this16._doRemove();
                      }
            ...
            },
            {
              ...
              value: function _onInvalidFile() {
                var types = this._imageHopper.accept.map(
                  getExtensionByMimeType
                );
                var error = this._options.statusFileType.replace(
                  '$0',
                  types.join(', ')
                );
            ...
            },
            {
              ...
              value: function _onImageTooSmall() {
                var error = this._options.statusImageTooSmall.replace(
                  '$0',
                  this._options.minSize.width +
                    ' \xD7 ' +
                    this._options.minSize.height
            ...
            },
            {
              ...
              value: function _onOverWeightFile() {
                var error = this._options.statusFileSize.replace(
                  '$0',
                  this._options.maxFileSize
                );
                this._throwError(error);
              }
            },
              ...
              value: function _load(resource, callback) {
                ...
                var load = function load() {
                  ...
                  _this18._loadTimeout = setTimeout(function() {
                    ...
                    snabbt(
                      _this18._element.querySelector('.slim-label-loading'),
                      {
                        fromOpacity: 0,
                        opacity: 1,
                        duration: 250
                ...
                if (
                  this._imageHopper &&
                  this._imageHopper.accept.indexOf(file.type) === -1
                ) {
                  exit();
                ...
                if (
                  file.size &&
                  this._options.maxFileSize &&
                  bytesToMegaBytes(file.size) > this._options.maxFileSize
                ) {
                  exit();
                ...
                // continue
                this._data.input.name =
                  options && options.name
                    ? options.name
                    : getFileNameByFile(file);
                ...
                if (isLowMemoryDevice()) {
                  internalCanvasSize = this._options
                    .internalCanvasSizeLowMemory;
                }

                // fetch resource
                getImageAsCanvas(file, internalCanvasSize, function(
                  image,
                  meta
                ) {
                  ...
                  var status = _this18._options.didLoad.apply(_this18, [
                    file,
                    image,
                    meta,
                    _this18
                  ...
                  _this18._options.willLoadCanvas.apply(_this18, [
                    image,
                    function(imageOut) {
                      // load the image
                      _this18._loadCanvas(
              ...
              value: function _loadCanvas(image, ready, complete, options) {
                ...
                if (!this._isFixedRatio()) {
                  if (this._initialCrop) {
                    this._ratio =
                      this._initialCrop.height / this._initialCrop.width;
                  } else {
                    this._ratio = isTilted
                ...
                var applyTransforms = function applyTransforms() {
                  ...
                  _this19._applyTransforms(image, function(transformedImage) {
                    ...
                    if (
                      _this19._options.service &&
                      _this19._options.push &&
                      !options.blockPush
                    ) {
                      // ...and is not transformation of initial image
                      // + is not instant edit mode
                      if (
                        !_this19._hasInitialImage &&
                        !_this19._canInstantEdit()
                      ) {
                        willUpload = true;
                    ...
                    // scale ratio
                    var ratio =
                      _this19._options.devicePixelRatio === 'auto'
                        ? window.devicePixelRatio
                        : _this19._options.devicePixelRatio;

                    // show intro animation
                    var introCanvas = cloneCanvasScaled(
                      transformedImage,
                      scalar * ratio
                    );
                    intro.src = '';
                ...
                if (this._initialCrop) {
                  ...
                  this._options.willCropInitial.apply(this, [
                    this.data,
                    function(rect) {
                      if (rect) {
                        ...
                        _this19._data.actions.crop = getAutoCropRect(
                          isTilted ? image.height : image.width,
                          isTilted ? image.width : image.height,
                          _this19._ratio
                        );
            ...
            },
            {
              ...
              value: function _applyTransforms(image, ready) {
                ...
                transformCanvas(image, actions, function(transformedImage) {
                  ...
                  if (
                    _this20._options.forceSize ||
                    (_this20._options.size &&
                      sizeDist(_this20._options.size, transformedImage) == 1)
                  ) {
                    ...
                    ctx.drawImage(
                      ...
                      0,
                      0,
                      _this20._options.size.width,
                      _this20._options.size.height
                    );
                  ...
                  if (
                    _this20._options.forceMinSize &&
                    _this20._options.size &&
                    _this20._options.minSize.width ===
                      _this20._options.size.width &&
                    _this20._options.minSize.height ===
                      _this20._options.size.height &&
                  ...
                  _this20._onTransformCanvas(function(transformedData) {
                    ...
                    _this20._options.didTransform.apply(_this20, [
                      _this20.data,
                      _this20
                    ]);
            ...
            },
            {
              ...
              value: function _onTransformCanvas(ready) {
                this._options.willTransform.apply(this, [
                  this.data,
                  ready,
                  this
                ]);
            ...
            },
            {
              ...
              value: function _onCancel(e) {
                ...
                if (
                  this._options.instantEdit &&
                  !this._hasInitialImage &&
                  this._isAutoCrop()
                ) {
                  this._doRemove();
                }
            ...
            },
            {
              ...
              value: function _onConfirm(e) {
                ...
                this._applyTransforms(this._data.input.image, function(
                  ...
                  _this22._options.didConfirm.apply(_this22, [
                    _this22.data,
                    _this22
                  ]);
                  ...
                  var intro =
                    images[0].className === 'out' ? images[0] : images[1];
                  ...
                  // scale ratio
                  var ratio =
                    _this22._options.devicePixelRatio === 'auto'
                      ? window.devicePixelRatio
                      : _this22._options.devicePixelRatio;

                  // new image get's
                  var introCanvas = cloneCanvasScaled(
                    transformedImage,
                    (intro.offsetWidth / transformedImage.width) * ratio
                  );
                  intro.src = '';
                  intro.src = introCanvas.toDataURL();
                  releaseCanvas(introCanvas);
            ...
            },
            {
              ...
              value: function _manualTransform(callback) {
                ...
                this._applyTransforms(this._data.input.image, function(
                  ...
                  // scale ratio
                  var pixelRatio =
                    _this23._options.devicePixelRatio === 'auto'
                      ? window.devicePixelRatio
                      : _this23._options.devicePixelRatio;

                  // new image
                  var introCanvas = cloneCanvasScaled(
                    transformedImage,
                    (intro.offsetWidth / transformedImage.width) * pixelRatio
                  );
                  intro.src = '';
                  intro.src = introCanvas.toDataURL();
                  releaseCanvas(introCanvas);
                  ...
                  intro.onload = function() {
                    ...
                    var willUpload =
                      _this23._options.service && _this23._options.push;
            ...
            },
            {
              ...
              value: function _save() {
                ...
                if (
                  ...
                  !(this._isInitialising && !this._isImageOnly())
                ) {
                  this._options.willSave.apply(this, [
                    data,
                    function(data) {
                      _this24._store(data);
                ...
                if (this._options.service && allowUpload) {
                  ...
                  this._options.willSave.apply(this, [
                    ...
                    function(data) {
                      ...
                      if (
                        _this24._imageHopper &&
                        _this24._options.dropReplace
                      ) {
                      ...
                      _this24._upload(data, function(err, res) {
                        ...
                        // we did upload data
                        _this24._options.didUpload.apply(_this24, [
                          err,
                          data,
                          res,
                          _this24
              ...
              value: function _storeServerResponse(data) {
                ...
                this._output.value =
                  (typeof data === 'undefined'
                    ? 'undefined'
                    : _typeof(data)) === 'object'
                    ? JSON.stringify(this._data.server)
                    : data;
              }
            ...
            },
            {
              ...
              value: function _upload(data, callback) {
                ...
                this.requestOutput(function(fileData, formData) {
                  var statusNode = _this25._element.querySelector(
                    '.slim-upload-status'
                  );
                  ...
                  var onSuccess = function onSuccess(obj) {
                    var timer = setTimeout(function() {
                      ...
                      statusNode.innerHTML =
                        _this25._options.statusUploadSuccess;
                  ...
                  var onError = function onError(status) {
                    ...
                    if (status === 'file-too-big') {
                      ...
                      html = _this25._options.didReceiveServerError.apply(
                        _this25,
                        [
                          status,
                          _this25._options.statusUnknownResponse,
                          _this25
                        ]
                      );
                    }
                  ...
                  if (typeof _this25._options.service === 'string') {
                    send(
                      _this25._options.service,
                      _this25._options.uploadMethod,
                      formData,
                      requestDecorator,
                      onProgress,
                      onSuccess,
                    ...
                    _this25._options.service.apply(_this25, [
                      _this25._options.serviceFormat === 'file'
                        ? fileData
                        : formData,
                      onProgress, // function(loaded, total) {}   // loaded bytes (number), total bytes (number)
                ...
                loadImage.parseMetaData(
                  ...
                  function(imageData) {
                    ...
                    if (inArray('input', _this26._options.post)) {
                      ...
                      // add to formdata
                      formData.append(
                        _this26._inputReference,
                        _this26._data.input.file,
                        _this26._data.input.file.name
                      );
                    }

                    // if image data is defined, turn it into a file object (we can send files if we're uploading)
                    if (
                      inArray('output', _this26._options.post) &&
                      _this26._data.output.image !== null &&
                      _this26._options.uploadBase64 === false
                    ) {
                      var output = base64ToBlob(
                        data.output.image,
                        data.output.name
                      );
                      ...
                      if (
                        imageData.imageHead &&
                        _this26._options.copyImageHead
                      ) {
                        try {
                          output = new Blob(
                            [
                              imageData.imageHead,
                              loadImage.blobSlice.call(output, 20)
                            ],
                            {
                      ...
                      var field = _this26._output.name || 'image';
            ...
            },
            {
              ...
              value: function _hideStatus() {
                var statusNode = this._element.querySelector(
                  '.slim-upload-status'
                );
                statusNode.style.opacity = 0;
              }
            ...
            },
            {
              ...
              value: function _doDownload() {
                ...
                downloadCanvas(
                  this._data,
                  this._options.jpegCompression,
                  this._options.forceType
                );
              }
            },
            {
              ...
              value: function _doDestroy() {
                ...
                if (this._imageHopper) {
                  HopperEvents.forEach(function(e) {
                    _this32._imageHopper.element.removeEventListener(
                      e,
                      _this32
                    );
                  });
                ...
                if (this._imageEditor) {
                  ImageEditorEvents.forEach(function(e) {
                    _this32._imageEditor.element.removeEventListener(
                      e,
                      _this32
                    );
                  });
                ...
                attributes.forEach(function(attribute) {
                  ...
                  if (
                    matchesAttributeInList(
                      attribute,
                      _this32._originalElementAttributes
                    )
                  ) {
                    return;
                  }
                ...
                this._originalElementAttributes.forEach(function(attribute) {
                  ...
                  // add attribute
                  _this32._originalElement.setAttribute(
                    attribute.name,
                    attribute.value
                  );
                });
          ...
          [
            {
              ...
              value: function options() {
                var defaults = {
                  ...
                  statusFileSize:
                    '<p>File is too big, maximum file size: $0 MB.</p>',
                  statusNoSupport:
                    '<p>Your browser does not support image cropping.</p>',
                  statusImageTooSmall:
                    '<p>Image is too small, minimum size is: $0 pixels.</p>',
                  statusContentLength:
                    '<span class="slim-upload-status-icon"></span> The file is probably too big',
                  statusUnknownResponse:
                    '<span class="slim-upload-status-icon"></span> An unknown error occurred',
                  statusUploadSuccess:
                    '<span class="slim-upload-status-icon"></span> Saved',
                  ...
                  didReceiveServerError: function didReceiveServerError(
                    err,
                    defaultError
                  ) {
                    return defaultError;
                ...
                SlimButtons.concat(ImageEditor.Buttons)
                  .concat('rotate')
      ...
      (function() {
        ...
        // labels
        ['FileSize', 'FileType', 'NoSupport', 'ImageTooSmall'].forEach(function(
          status
        ) {
        ...
        Slim.parse = function(context) {
          ...
          while (i--) {
            element = elements[i];
            croppers.push(
              Slim.create(element, Slim.getOptionsFromAttributes(element))
            );
          }
